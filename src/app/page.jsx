...
export default function HomePage() {
  return (
    <section className="w-full bg-bg-primary pt-(--header-height)">
      {/* wrapper */}
      <div className="max-w-360 mx-auto px-4 h-auto max-h-256 py-10 flex flex-col gap-8 lg:flex-row lg:justify-between lg:gap-4 relative">
        ...
        <div className="order-2 lg:order-1 lg:w-2/5 flex flex-col gap-8 justify-center items-start sm:w-4/5 sm:self-center lg:-mt-20  ">
          ...
          {/* heading */}
          <p className="text-[clamp(2rem,4vw,4.5rem)] lg:w-[135%]  lg:relative lg:z-10 font-primary font-medium">
        ...
        <div className="order-1 lg:order-2 grid grid-cols-6 grid-rows-5 aspect-4/3 sm:w-4/5 sm:self-center lg:w-3/5 relative  ">
          <div className="absolute top-1/2 -translate-y-1/2 right-0 w-full h-3/4 bg-bg-secondary z-0 max-w-180 " />
