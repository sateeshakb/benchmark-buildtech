...
export const ServiceCardData = {
  interiorServices: [
    {
      id: 1,
      icon: <Hammer size={30} className="text-secondary-500" />,
      title: "Construction & Fit-out Upgrades",
      text: "From ground-up construction to detailed refurbishments, we handle fit-out upgrades with precision.",
    },
    {
      id: 2,
      icon: <Building size={30} className="text-secondary-500" />,
    ...
    {
      id: 3,
      icon: <BadgeCheck size={30} className="text-secondary-500" />,
      title: "Cost & Quality Management",
      text: "Transparent cost control, value engineering, and strict quality assurance across all stages ensuring every project is delivered on time, within budget.",
    },
    {
      id: 4,
      icon: <Home size={30} className="text-secondary-500" />,
    ...
    {
      id: 5,
      icon: <KeyRound size={30} className="text-secondary-500" />,
      title: "Turnkey Interior Solutions",
      text: "Single-point responsibility from planning to handover, ensuring seamless coordination and execution.",
    },
    {
      id: 6,
      icon: <GanttChart size={30} className="text-secondary-500" />,
      title: "Project Management Services",
      text: "Structured planning, scheduling, budgeting, execution control, and quality oversight to keep every project on track from start to finish.",
    },
  ],
  ...
  advisoryServices: [
    {
      id: 1,
      icon: <Handshake size={30} className="text-secondary-500" />,
    ...
    {
      id: 5,
      icon: <Database size={30} className="text-secondary-500" />,
  ...
  whoWeServeData: [
    ...
    {
      id: 2,
      icon: <Building2 size={30} className="text-secondary-500" />,
    ...
    {
      id: 4,
      icon: <Store size={30} className="text-secondary-500" />,
    ...
    {
      id: 5,
      icon: <TrendingUp size={30} className="text-secondary-500" />,
